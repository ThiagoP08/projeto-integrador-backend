...
<body>
	...
	<%
		...
		out.println("<th style='width: 10%; border-right: solid 1px; border-bottom: solid 1px'> Descri��o </th>");
		out.println("<th style='width: 10%; border-right: solid 1px; border-bottom: solid 1px'> Pol�tica </th>");
		...
		out.println("<th style='width: 10%; border-right: solid 1px; border-bottom: solid 1px'> ID do Admin </th>");
	...
	<%
		...
		out.println("<th style='width: 10%; border-right: solid 1px; border-bottom: solid 1px'> Endere�o </th>");
	...
	<%
		...
		out.println("<th style='width: 10%; border-right: solid 1px; border-bottom: solid 1px'> ID </th>");
		out.println("<th style='width: 10%; border-right: solid 1px; border-bottom: solid 1px'> Status </th>");
		out.println("<th style='width: 10%; border-bottom: solid 1px'> ID do Usu�rio </th>");
	...
	<%
		...
		out.println("<th style='width: 10%; border-right: solid 1px; border-bottom: solid 1px'> ID do Usu�rio </th>");
